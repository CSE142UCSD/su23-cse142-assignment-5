...
This assignment is in a Jupyter notebook (`assignment5.ipynb`).  To run it'll you'll need to
...
Switch to the tab with file browser and navigate to the directory you just cloned.   Click on `assignment5.ipynb` to open the lab and get to work!
